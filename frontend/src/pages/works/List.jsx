...
export default function WorkList() {
  ...
  return <div><div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}><Title level={4} style={{ margin: 0 }}>📫 作品管理</Title>{user?.role === 'academic_mentor' && <Button type="primary" icon={<PlusOutlined />} onClick={() => navigate('/works/upload')}>上传作品</Button>}</div>
