...
| 学生 `student` | 注册、课程浏览与课程回顾（摘要/回放/资料/任务/我的提交）、完成课后任务并提交作品、反思日志、个人成长档案、滑翔机模拟试飞 |
| 新媒体 `media` | 课程浏览（只读）、帮助与反馈、通知中心 |

> 学生选课统一由管理员/学术导师线下报名完成（前端已下线自助选课入口）；作品上传仅限学生本人（从课后任务入口提交），教师与导师均不参与作品上传；教师仅能查看公开发布（已通过批改）的作品，不参与批改。
