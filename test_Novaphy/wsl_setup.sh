#!/usr/bin/env bash
# wsl_setup.sh — 在 WSL Ubuntu 24.04 里准备 novaPhy 交互环境
# 用法(Windows):  wsl -d Ubuntu-24.04 -u root -- bash /mnt/d/.../wsl_setup.sh
set -euxo pipefail
...
WHEEL=/mnt/d/html-source/PBLproject/jointproject/test_Novaphy/novaphy-0.4.0-cpu-cp311-linux-x86_64/novaphy-0.4.0-cp311-cp311-linux_x86_64.whl
